            ...
            <div class="row m-0">
                <div class="col-lg-5 col-md-6 p-0 order-md-first order-last">
                    <div class="hero d-flex justify-content-center flex-column align-items-center">
                            ...
                            Każdy zwycięzca zasługuje na piękny medal.<br>A każdy medal ma prawo być tak inny jak wydarzenie, podczas którego jest wręczany a nawet tak inny, jak jego zwycięzcy.
                            </p>
